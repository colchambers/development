module.exports = function () {
    ...
    this.Then(/^element "([^"]*)" "([^"]*)" should be "([^"]*)"$/, function (selector, attribute, value) {
        // helpers.waitUntilAttributeExists(selector, attribute, 5000);
        var actualValue = helpers.getAttributeValue(selector, attribute).then(function(inputValue){
            // expect(inputValue).to.match(value)
            return inputValue;
        });
        return expect(actualValue).to.match(value);
    });
};
